...
```mermaid
flowchart TD
    A["💵 Flujo de Caja en Bolívares (Bs.)"] --> B["Q1 15-Ago: 190.305,00 Bs."]
    A --> C["Q2 30-Ago: 164.472,02 Bs. + Pastoral: 93.000 Bs."]
    A --> D["Extra Rebeca: $140 USD (128.241,13 Bs.)"]
    A --> E["Q3 15-Sep: 210.552,50 Bs. ($250 USD)"]

    B --> F["USDT ($25) + Diezmo ($45) + Comida ($75) + Cashea + Zapatos/Lentes/Pasajes"]
    C --> G["USDT ($25) + Diezmo ($25) + Vacuna Neumococo ($65) + Pediatra ($30) + Abonos"]
    D --> H["Ofrenda + Ahorro + Alba + Libre (Fomeetodo)"]
    E --> I["USDT ($25) + Diezmo ($25) + Cashea ($41) + Comida + Pañales + Nelly"]
```
