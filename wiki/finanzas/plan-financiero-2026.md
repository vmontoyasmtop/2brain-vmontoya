...
```mermaid
flowchart TD
    A["💰 Flujo Financiero Consolidado"] --> B["🟢 Ingreso Mensual Real Operativo: $620.00 USD"]
    A --> C["🔵 Proyección Extraordinaria por Cobrar: $6,000.00 USD (finance-ms)"]
    
    B --> D["🏢 Salario Fijo Xetux: $500.00 USD"]
    B --> E["⛪ Sueldo Pastoral: $120.00 USD"]
    
    D & E --> F["🏡 Gastos Fijos + Diezmo: $438.00 USD"]
    D & E --> G["🛡️ Ahorro Mínimo 10% USDT: $62.00 USD"]
    D & E --> H["🧹 Plan Amortización Deudas: $120.00 USD/mes"]
    
    C -.-> I["🚀 Destino al Cobrar: Liquidación Acelerada de Deudas + Fondo USDT Binance"]
```
