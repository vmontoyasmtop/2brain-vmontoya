...
```mermaid
flowchart TD
    A["Dirección General (Sr. Emiliano)"] --> B["Analista IT & Líder de Arquitectura (Ing. Víctor Montoya)"]
    B --> C1["Desarrollo & Arquitectura MasterHub"]
    B --> C2["👤 Soporte Técnico IT Jr. (Nivel 1) - NUEVO"]
    C2 --> D1["Atención Helpdesk & Impresoras"]
    C2 --> D2["Soporte Sucursales Xetux"]
    C2 --> D3["Toma Física Semanal de Inventario"]
```
